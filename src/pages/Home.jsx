  ...
  return (
    <>
      <section className="py-5">
        <div className="flex flex-col px-10 gap-3 justify-center max-w-lg m-auto sm:flex-row sm:flex-wrap sm:max-w-2xl lg:flex-nowrap lg:max-w-7xl">
          <div className="h-60 sm:h-96 lg:h-[500px] relative">
          ...
          <div className="flex flex-col gap-3 justify-center max-w-lg m-auto sm:flex-row sm:flex-wrap sm:max-w-2xl">
